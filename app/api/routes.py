...
from app.api.endpoints.user.get_user_by_email import router as get_user_by_email_router
# from app.api.v1.endpoints.user import router as user_router

routers = APIRouter()
router_list = [health_check_router, create_user_router, login_router, get_user_by_email_router]
